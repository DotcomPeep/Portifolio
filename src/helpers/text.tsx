...
export const Text = () => {
    return(
        <h3>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever
...
/*Seja bem vindo ao meu site pessoal, me chamo Leonardo e tenho 22 anos. Sou aficionado por tecnologia desde meu
